...
class KeyboardData
{
  ...
  public static class Key
  {
    ...
    /* Repeat key while swiping */
    public final boolean swipekeys;

    protected Key(KeyValue k0, KeyValue k1, KeyValue k2, KeyValue k3, KeyValue k4, float w, float s, boolean e, boolean m)
    {
      key0 = k0;
      key1 = k1;
      key2 = k2;
    ...
    public static Key parse(XmlResourceParser parser) throws Exception
    {
      ...
      boolean swipekeys = parser.getAttributeBooleanValue(null, "swipekeys", false);
      while (parser.next() != XmlResourceParser.END_TAG)
        continue ;
      return new Key(k0, k1, k2, k3, k4, width, shift, edgekeys, swipekeys);
    }
    ...
    {
      return new Key(key0, key1, key2, key3, key4, width * s, shift, edgekeys, swipekeys);
    }
  }
