  ...
  implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    if (!_config.move_cursor_with_volume || conn == null || !isInputViewShown()) {
  ...
  public boolean onKeyUp(int keyCode, KeyEvent event) {
    if (!_config.move_cursor_with_volume || keyCode == KeyEvent.KEYCODE_VOLUME_UP || keyCode == KeyEvent.KEYCODE_VOLUME_DOWN)
      return true;
